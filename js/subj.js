class Subject {
    constructor(options = {}) {
        Object.assign(this, {
            num: 'pre-post',
            subjNumScript: '',
            subjNumCallback: () => void 0, //defining function w an empty function (slightly dif tho)
            savingScript: '',
            subjNumFile: '',
            visitFile: 'visit.txt',
    ...
    obtainSubjNum() {
        ...
        //four parameters(data, path, callback function sucess, callback function failure)
    }
    ...
    saveVisit() {
        ...
        //store this to pure txt file (so easier to paste to excel)
